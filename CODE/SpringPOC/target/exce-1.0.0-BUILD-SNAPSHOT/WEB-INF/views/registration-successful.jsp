...
<div class="annexure-form" >
  <div class="annexure-form-header"> REGISTRATION SUCCESSFUL <img src="resources/images/RegisterRight.png" class="pull-right icon"> </div>
  <div class="form-horizontal company form-regisration">
    <div class="col-sm-12 success">
    <div class="division"></div>
      <p>Thank you for signing up. Your Login and Password has been mailed to your email ID
         ${register.emailId} </p>
      <br>
    </div>
    <table class="table">
      <tbody>
       ...
       <td>:  ${register.firstName}</td>
        ...
        <tr>
          <td>Mobile Number</td>
          <%-- <td><core:out value="${registration.mobileNumber}" /></td> --%>
          <td>: ${register.mobileNumber}</td>
        </tr>
        <tr>
          <td>Email ID</td>
           <%-- <td><core:out value="${registration.emailId}" /></td> --%>
           <td>:  ${register.emailId}</td>
        </tr>
        <tr>
          <td colspan="2" class="division-2"></td>
        </tr>
        <tr>
          <td class="td-1"></td>
          <td>
