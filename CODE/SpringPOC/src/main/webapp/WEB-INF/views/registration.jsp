  ...
  <body>
    <div class="annexure-form" >
      ...
      <div class="annexure-form-header">
        <span id="errinvalid" class="hidden" >
          INVALID
        </span>
        REGISTRATION INFORMATION 
        <span id="imginvalid">
          <img src="resources/images/Register.png" class="pull-right icon" alt="">
        </span>
      ...
      <form action="saveRegisteration" class="form-horizontal company form-regisration" method="post" role="form" name="regisration"  id="regisration" >
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="submit" class="btn btn-default btn-sm btnsubmit-regisration" value="SUBMIT" />
          </div>
        </div>
      </form>
      <!--//form -->
    ...
    <div class="annexure-form" id="error" >
      <div class="annexure-form-header">
        REGISTRATION ERROR 
      ...
      <div class="form-horizontal company form-regisration">
        <div class="col-sm-12 error">
          ...
          <p>
            ...
            <br>
            000 (Failed to connect internet)
            <br>
            &bull; Check that all network cables are plugged in.
            <br>
            &bull; Verify that airplane mode is turned off.
            <br>
            &bull; Make sure your wireless switch is turned on.
            <br>
            &bull; See if you can connect to mobile broadband.
            <br>
            &bull; Restart your router. 
          </p>
          <br>
        </div>
        <div class="clearfix">
